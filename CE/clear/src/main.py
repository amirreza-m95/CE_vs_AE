...
parent_dir = os.path.join(current_dir, 'CE/clear/dataset')
...
def run_clear(args, exp_type):
    ...
    pred_model.load_state_dict(torch.load(os.path.join(os.path.dirname(os.path.abspath(__file__)), model_path , f'prediction/weights_graphPred__{args.dataset}' + '.pt') ))
    pred_model.eval()
