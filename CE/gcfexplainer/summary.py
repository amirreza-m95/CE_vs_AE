...
if __name__ == '__main__':
    ...
    neurosed_model = distance.load_neurosed(original_graphs, neurosed_model_path=os.path.join(sys.path[0] ,f'data/{dataset_name}/neurosed/best_model.pt'), device=device)
